...
def main():
    parser = argparse.ArgumentParser(description="UNSW-NB15 Leave-One-Attack-Type-Out with Random Forest")
    ...
    summary_df.to_csv(os.path.join(args.out_dir, "rf_leave_one_attack_type_summary.csv"), index=False)
    ...
    with open(os.path.join(args.out_dir, "rf_overall_summary.json"), "w") as f:
